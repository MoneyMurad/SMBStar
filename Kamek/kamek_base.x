SECTIONS {
	...
	someFlightRelatedFunction = 0x8013c530;
	hipAttackStuffizoids = 0x80048f30;
...
/* Mr Sun Related */
	...
	*/
	...
	breakBlock = 0x809c1020;
	
	returnFromExtensionChange = 0x8091f14c;
	returnFromInputDetection = 0x809205c0;
	notReleasingThisSourceCode = 0x809205c8;
	
	returnFromLimiterFix = 0x8007a954;
	freddyFazbearion = 0x8007a9f4;
	continueFromTopFix = 0x80156840;
	screenTop = 0x80D25D60;
